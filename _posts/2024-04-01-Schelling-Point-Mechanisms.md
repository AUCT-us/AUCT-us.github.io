...
A "Schelling focal point mechanism" is another way to describe the way things are as result of cultural inertia OR to describe how things got to be the way they now are as a natural result of people reacting to external changes on the system in the past. The focal point term has resulted from work in game theory to refer conceptually to how people focus on a shared result naturally, without prior communication, or tend to converge *focally* on a specific solution or outcome because it seems most prominent or obvious to them, essentially acting as an understood, more-or-less agreed upon **focal point** in a situation where coordination is needed. The convergence is essentially a market or akin to how market coordination or bidding works more-or-less ***naturally***. There's often more going on behind-the-scenes in private deliberations and personal decisionmaking -- it's NOT a matter of collusion or agreement, but simply a matter of people weighing their choices; it's always the case that markets never waste new information, but the result might not always seem so fair or just. Markets never waste new information/

The focal point concept is also known as a Schelling point; it is named after economist Thomas Schelling who extensively studied it in his work on conflict strategy. A focal point (or Schelling point) is a solution which is not really an optimal solution, but people tend to choose by default in the absence of communication in order to avoid coordination failure ... because *upsetting the apple cart* or disrupting the status quo or provoking revolution makes all of the participants worse off [at least initially]. The points about Schelling focal points: very little information used and communication is usually neither required or sometimes even desired. The key aspect is that individuals can arrive at the same expected low-risk decision even without explicitly discussing it with others; the Schelling focal point is usually a choice that seems most likely to be chosen by others due to its inherent characteristics or conformance cultural norms, ie it's the idea that almost immediately emerges as the natural de facto starting point for any conversations or negotiations.

Schelling focal points are why unreviewed, pre-print arxiv papers are so NECESSARY ... **MARKETS NEVER WASTE NEW INFORMATION** even when it is not approved by peers OR maybe BECAUSE it is not approved by peers. **MARKETS NEVER WASTE NEW INFORMATION ... ** the discussion of disruptive ideas helps everyone to JUST think; it's not that the ideas are adopted, it's that the ideas advance the overall level of thinking and theorizing.

In the realm of information technology, we often think about consensus algorithms for assigning the most correct value to a variable -- it's not that the value assigned is perfect; it's that it closer to a consensus value suggested from all points, ie the consensus might be wrong, but as a PRACTICAL matter a database must rapidly converge on the consensus value. Making sure that consensus value is correct or an accurate depiction of Reality is a separate matter. Quantum error-correction technologies have emergently shown us why errors/contradictions or understading what is NOT real or what cannot possibly be real can actually be an important part understanding Reality. **MARKETS NEVER WASTE NEW INFORMATION.**
